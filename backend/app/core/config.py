...
class Settings(BaseSettings):
    ...
    CORS_ORIGINS: str = "http://localhost:5173,http://127.0.0.1:5173,http://localhost:5174,http://127.0.0.1:5174,http://localhost:3000,http://127.0.0.1:3000,https://ready-nest-internship-week-1-git-main-rizul.vercel.app,https://ready-nest-internship-week-1.vercel.app"
